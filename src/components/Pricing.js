...
function Pricing() {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`border-2 ${plan.color} rounded-2xl p-8 bg-white shadow-lg hover:shadow-2xl transition duration-300`}
            >
              {plan.popular && (
              ...
              <div className="text-center">
                <Link
                  to="/booking"
                  className={`${plan.button} px-6 py-3 rounded-full font-semibold hover:opacity-90 transition`}
                >
                  จองแพ็กเกจนี้
                </Link>
              </div>
 ...
 <div className=" py-16">
  <div className="max-w-5xl mx-auto  rounded-2xl p-10 text-gray-700 leading-8">

    <ol className="list-decimal pl-6 space-y-4">

      <li>
        การจองคอร์ทออนไลน์ ทาง เว็บไซต์ : www.trumqbadminton.com มีเวลาจำกัด 5 นาทีในการทำการจองในระบบ และ 
